...
// **
// **   - 'nombre_archivo' nombre del archivo (se le aÃ±ade .ply si no
// **     acaba en .ply)
...
// **   - solo admite plys con triÃ¡ngulos,
...
(
   ...
   std::vector<int> &   caras               // salida:  vector de triÃ¡ngulos (Ã­ndices)
);
...
// ** ply::read_vertices
// **
// **  lee los vÃ©rtices de un archivo ply y los carga en 'vertices'
// **
// **   - 'nombre_archivo' nombre del archivo (se le aÃ±ade .ply si no
// **     acaba en .ply)
// **   - si hay un error, aborta
...
// **     vector 'vertices'
// **   - lee el archivo .ply y carga los vÃ©rtices en 'vertices'
// **   - no lee colores, caras, coordenadas de textura, ni normales.
// **   - se ignora la informaciÃ³n de caras
// **
// *********************************************************************
