...
Torillo::Torillo() {
    ...
    cubo.calcular_normales_triangulos();
    cubo.calcular_normales_vertices();
    prisma_triangular.calcular_normales_triangulos();
    prisma_triangular.calcular_normales_vertices();
    cilindro.calcular_normales_triangulos();
    cilindro.calcular_normales_vertices();
...
void Torillo::draw_chasis_base(const int &modo) {
    ...
    glTranslatef(0,55,0);
    glScalef(200,50,150);
    cubo.setAmbiental(_vertex4f(0.8,0.8,0.2,1));
    cubo.setDifusa(_vertex4f(0.4,0.4,0,1));
    cubo.setEspecular(_vertex4f(0.5,0.5,0.5,1));
    cubo.setBrillo(30);
    cubo.dibujar(modo);
    glPopMatrix();
}
...
void Torillo::draw_chasis_mandos(const int &modo) {
    ...
    glScalef(50,30,150);
    prisma_triangular.setAmbiental(_vertex4f(0.8,0.8,0.2,1));
    prisma_triangular.setDifusa(_vertex4f(0.4,0.4,0,1));
    prisma_triangular.setEspecular(_vertex4f(0.5,0.5,0.5,1));
    prisma_triangular.setBrillo(30);
...
void Torillo::draw_palo_cabina(const int &modo) {
    ...
    glPushMatrix();
    glScalef(5,100,5);
    cubo.setAmbiental(_vertex4f(0.4,0.4,0.4,1));
    cubo.setDifusa(_vertex4f(0.2,0.2,0.2,1));
    cubo.setEspecular(_vertex4f(0.5,0.5,0.5,1));
    cubo.setBrillo(50);
    cubo.dibujar(modo);
    glPopMatrix();
...
void Torillo::draw_espaldera(const int &modo) {
    ...
    glScalef(10,50,60);
    cubo.setAmbiental(_vertex4f(0.1,0.1,0.1,1));
    cubo.setDifusa(_vertex4f(0.1,0.1,0.1,1));
    cubo.setEspecular(_vertex4f(0.3,0.3,0.3,1));
    cubo.setBrillo(10);
    cubo.dibujar(modo);
    glPopMatrix();
}
...
void Torillo::draw_rueda(const int &modo) {
    ...
    glRotatef(90,1,0,0);
    glScalef(60,30,60);
    cilindro.setAmbiental(_vertex4f(0.1,0.1,0.1,1));
    cilindro.setDifusa(_vertex4f(0.2,0.2,0.2,1));
    cilindro.setEspecular(_vertex4f(0.3,0.3,0.3,1));
    cilindro.setBrillo(20);
...
void Torillo::draw_soporte_volante(const int &modo) {
    ...
    glPushMatrix();
    glScalef(10,40,10);
    cilindro.setAmbiental(_vertex4f(0.2,0.2,0.2,1));
    cilindro.setDifusa(_vertex4f(0.3,0.3,0.3,1));
    cilindro.setEspecular(_vertex4f(0.5,0.5,0.5,1));
    cilindro.setBrillo(20);
    cilindro.dibujar(modo);
    glPopMatrix();
}
...
void Torillo::draw_volante(const int &modo) {
    ...
    cilindro.setAmbiental(_vertex4f(0.1,0.1,0.1,1));
    cilindro.setDifusa(_vertex4f(0.2,0.2,0.2,1));
    cilindro.setEspecular(_vertex4f(0.2,0.2,0.2,1));
    cilindro.setBrillo(10);
    cilindro.dibujar(modo);
    glPopMatrix();
}
...
void Torillo::draw_soporte_pala(const int &modo) {
    ...
    glTranslatef(0,95,0);
    glScalef(30,10,20);
    cubo.setAmbiental(_vertex4f(0.5,0.5,0.5,1));
    cubo.setDifusa(_vertex4f(0.6,0.6,0.6,1));
    cubo.setEspecular(_vertex4f(0.8,0.8,0.8,1));
    cubo.setBrillo(60);
    cubo.dibujar(modo);
    glPopMatrix();
}
...
void Torillo::draw_extremo_pala(const int &modo) {
    ...
    glRotatef(180,0,1,0);
    glScalef(20,5,20);
    prisma_triangular.setAmbiental(_vertex4f(0.5,0.5,0.5,1));
    prisma_triangular.setDifusa(_vertex4f(0.6,0.6,0.6,1));
    prisma_triangular.setEspecular(_vertex4f(0.8,0.8,0.8,1));
    prisma_triangular.setBrillo(60);
    prisma_triangular.dibujar(modo);
    glPopMatrix();
}
